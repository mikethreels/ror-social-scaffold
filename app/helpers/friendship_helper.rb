module FriendshipHelper
    ...
    def invite_button(user_id)
      (button_to 'invite', friendships_path, method: :post, params: { friend_id: user_id }).html_safe unless (@confirmed_friends + @pending_friends).include?(user_id) || current_user.id == user_id
    end
end
